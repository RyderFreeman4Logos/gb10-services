...
export interface LlmMetrics {
  ...
  prefillTps: number;
  /** vLLM rate evidence: fresh counter advance, stale last observation, unavailable, or idle. */
  generationTpsState?: "fresh" | "stale" | "unavailable" | "idle" | null;
  prefillTpsState?: "fresh" | "stale" | "unavailable" | "idle" | null;
  /** Age of the last positive vLLM counter window; null if no observed rate exists. */
  generationTpsAgeSeconds?: number | null;
  prefillTpsAgeSeconds?: number | null;
