...
require_unit() {
    case "$1" in
        vllm-aeon-27b-dflash.service|vllm-aeon-27b-dflash-hikv.service|vllm-aeon-qwen38-dflash.service|vllm-aeon-ultimate-uncensored-nvfp4.service|vllm-embedding.service|vllm-querit-4b-reranker.service|vllm-qwen3-reranker-8b.service)
            ;;
        *)
